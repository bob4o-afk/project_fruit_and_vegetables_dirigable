...
export class ItemStatusRepository {
    ...
    private async triggerEvent(data: ItemStatusEntityEvent | ItemStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("project_fruit_and_vegetables_dirigable-ItemStatus-ItemStatus", ["trigger"]);
        ...
        producer.topic("project_fruit_and_vegetables_dirigable-ItemStatus-ItemStatus").send(JSON.stringify(data));
    }
}

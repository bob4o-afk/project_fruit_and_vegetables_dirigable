...
export class PurchaseStatusRepository {
    ...
    private async triggerEvent(data: PurchaseStatusEntityEvent | PurchaseStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("project_fruit_and_vegetables_dirigable-Settings-PurchaseStatus", ["trigger"]);
        ...
        producer.topic("project_fruit_and_vegetables_dirigable-Settings-PurchaseStatus").send(JSON.stringify(data));
    }
}
